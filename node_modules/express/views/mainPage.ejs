            ...
            ({
               ...
               contentType: "application/json; charset=UTF-8",
                  ...
                  response.ids.forEach(function(obj){
                      tweetTag += `<div id =${obj} onmouseover="updateTweetInfo('${obj}')" onmouseout="clearTweetInfo()"><blockquote class='twitter-tweet' data-lang='en'><a href='https://twitter.com/<%=currentUser.username%>/status/${obj}'></a></blockquote></div>`;
                  });
