...
<div class="container-fluid" id="pageContainer">
    ...
    <div class="col-4 md">
      <div class="card">
       ...
       <div class="card" class="smallGraph">
              <div class="card-body" id ="tweetInfo">
  ...
  <script type="text/javascript">
        ...
        $.ajax
            ({
               ...
               contentType: "application/json; charset=UTF-8",
                  ...
                  var sourceTag=`<div><h3>Source: ${tweetData.source}</h3></div>`;
    ...
    function clearTweetInfos(){
      document.getElementById("tweetInfo").innerHTML='<div></div>';
      document.getElementById("sourceInfo").innerHTML='<div></div>';
    }
