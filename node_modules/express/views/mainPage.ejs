    ...
    <div class="col-3 md">
      <div class="card">
       ...
       <div class="card" class="smallGraph">
        ...
        <div class="card" class="smallGraph">
               <div class="card-body">
             <canvas id="Canvas3" width="" height="" ></canvas>
    ...
    <div class="col-5 md">
      <div class="card" id="tweet">
             <div class="card-body" id="tweetBody">
               <blockquote class="twitter-tweet" data-lang="en"><p lang="und" dir="ltr"><a href="https://t.co/7VQGHx5mFE">pic.twitter.com/7VQGHx5mFE</a></p>&mdash; The Artsy Bot (@artsybot) <a href="https://twitter.com/artsybot/status/1062363540395380736?ref_src=twsrc%5Etfw">November 13, 2018</a></blockquote>
